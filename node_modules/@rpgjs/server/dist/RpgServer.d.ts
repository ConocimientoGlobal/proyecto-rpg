...
import { RpgPlayer, RpgPlayerRoom, RpgEvent } from './Player/Player';
import { RpgMap, RpgRoomConnection, EventPosOption, RpgTouchContext } from './rooms/map';
import { RpgServerEngine } from './RpgServerEngine';
import { WorldMapConfig, RpgShape, I18nMessages, MapPhysicsInitContext, MapPhysicsEntityContext, RpgActionInput, RpgRoomDescriptor } from '@rpgjs/common';
import { MaybePromise, RpgMapChangeTarget, RpgPlayerSnapshot, RpgSyncSchema } from './Player/types';
import { DamageFormulas } from './Player/BattleManager';
import { SkillChangePayload } from './Player/SkillManager';
import { HotbarChangePayload } from './Player/HotbarManager';
import { ProjectileDestroyHookContext, ProjectileHookContext, ProjectileImpactHookContext } from './projectiles';
...
export interface RpgServerEngineHooks {
     ...
     * @memberof RpgServerEngineHooks
     */
    onStep?: (server: RpgServerEngine, metrics: RpgServerStepMetrics) => MaybePromise<void>;
    /**
