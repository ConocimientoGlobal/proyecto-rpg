import { SaveSlotMeta } from '@rpgjs/common';
...
export type RpgSyncProperty = StringConstructor | NumberConstructor | BooleanConstructor | ObjectConstructor | ArrayConstructor | RpgSyncPropertyOptions | RpgSyncSchema | readonly [RpgSyncProperty];
...
export type RpgPlayerSlotLoadResult = RpgPlayerSlotLoadSuccess | RpgPlayerSlotLoadFailure;
