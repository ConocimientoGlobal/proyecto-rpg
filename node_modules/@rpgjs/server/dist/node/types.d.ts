...
export type RpgRoomStorageFactory = (namespace: string, roomId: string) => RpgRoomStorage | Promise<RpgRoomStorage>;
...
export type RpgSqliteJournalMode = "DELETE" | "TRUNCATE" | "PERSIST" | "MEMORY" | "WAL" | "OFF" | "delete" | "truncate" | "persist" | "memory" | "wal" | "off";
...
export interface RpgHostedRoomConnection<TState = unknown> {
    ...
    setState(state: TState | ((previous: Readonly<TState> | null) => TState) | null): Readonly<TState> | null;
