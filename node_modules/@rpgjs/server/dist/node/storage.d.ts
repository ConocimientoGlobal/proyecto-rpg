import { RpgMemoryRoomStorageProvider, RpgMemoryStorageOptions, RpgRoomStorageProvider, RpgSqliteStorageOptions } from './types';
/**
 ...
 * ```
 */
export declare function createMemoryNodeRoomStorage(options?: RpgMemoryStorageOptions): RpgMemoryRoomStorageProvider;
/**
 ...
 * ```
 */
export declare function createSqliteNodeRoomStorage(options: RpgSqliteStorageOptions): RpgRoomStorageProvider;
