...
function component($$props) {
	...
	return h(Canvas, {
	...
	}, [cond(computed(() => isMapScene()), () => h(Viewport, {
		worldWidth,
		worldHeight,
		clamp,
		...
		h(SceneMap)
	]), [computed(() => RoomScene()), () => h(RoomScene(), {
		room: engine.sceneRoom,
		descriptor: computed(() => engine.activeRoom())
		...
		width: engine.width,
		height: engine.height
	}, cond(computed(() => gui.display()), () => h(gui.component, {
		data: gui.data,
