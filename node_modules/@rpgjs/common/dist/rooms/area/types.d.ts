import { RpgCommonMap, MapHitboxQueryKind, MapHitboxQueryRect } from '../Map';
export type MapAreaTargetKind = MapHitboxQueryKind | "custom";
export type MapAreaTargetSelector = MapAreaTargetKind | MapAreaTargetKind[] | "all";
...
export type MapAreaCenter = MapAreaPoint | {
    id?: string;
    x: number | (() => number);
    y: number | (() => number);
    hitbox?: (() => {
