...
export type RpgProviderToken<T = unknown> = string | (new (...args: any[]) => T);
/**
...
export type RpgProvider<T = unknown> = (new (...args: any[]) => T) | RpgValueProvider<T> | RpgClassProvider<T> | RpgFactoryProvider<T> | RpgExistingProvider;
