...
import { ClipProps, OcclusionProps, OutlineProps } from '../../directives/SpriteEffects';
...
export type PixiStrokeObject = Extract<NonNullable<Parameters<PIXI.Graphics["stroke"]>[0]>, object>;
